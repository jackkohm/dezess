#!/bin/bash
#SBATCH --job-name=bench_nuts_bj
#SBATCH --output=slurm_bench_nuts_bj_%j.out
#SBATCH --error=slurm_bench_nuts_bj_%j.err
#SBATCH --time=0:20:00
...
conda run --no-capture-output -p /gpfs/scrubbed/jackkohm/conda-envs/Astro python -u bench_nuts_vs_blackjax_truth.py
