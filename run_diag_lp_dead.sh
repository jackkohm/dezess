#!/bin/bash
#SBATCH --job-name=diag_lp_dead
#SBATCH --output=slurm_diag_lp_dead_%j.out
#SBATCH --error=slurm_diag_lp_dead_%j.err
#SBATCH --time=0:10:00
...
conda run --no-capture-output -p /gpfs/scrubbed/jackkohm/conda-envs/Astro python -u diag_lp_dead.py
