#!/bin/bash
#SBATCH --job-name=diag_speckle
#SBATCH --output=slurm_diag_speckle_%j.out
#SBATCH --error=slurm_diag_speckle_%j.err
#SBATCH --time=0:10:00
...
conda run --no-capture-output -p /gpfs/scrubbed/jackkohm/conda-envs/Astro python -u diag_speckle.py
