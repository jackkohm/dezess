#!/bin/bash
#SBATCH --job-name=bench_cp_eff
#SBATCH --output=slurm_bench_cp_eff_%j.out
#SBATCH --error=slurm_bench_cp_eff_%j.err
#SBATCH --time=0:45:00
...
conda run --no-capture-output -p /gpfs/scrubbed/jackkohm/conda-envs/Astro python -u bench_cp_efficiency.py
