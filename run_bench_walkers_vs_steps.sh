#!/bin/bash
#SBATCH --job-name=bench_wvs
#SBATCH --output=slurm_bench_wvs_%j.out
#SBATCH --error=slurm_bench_wvs_%j.err
#SBATCH --time=0:40:00
...
conda run --no-capture-output -p /gpfs/scrubbed/jackkohm/conda-envs/Astro python -u bench_walkers_vs_steps.py
