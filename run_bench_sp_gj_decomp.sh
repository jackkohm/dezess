#!/bin/bash
#SBATCH --job-name=bench_sp_gj
#SBATCH --output=slurm_bench_sp_gj_%j.out
#SBATCH --error=slurm_bench_sp_gj_%j.err
#SBATCH --time=0:45:00
...
conda run --no-capture-output -p /gpfs/scrubbed/jackkohm/conda-envs/Astro python -u bench_sp_gj_decomp.py
