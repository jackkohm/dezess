#!/bin/bash
#SBATCH --job-name=bench_wscale
#SBATCH --output=slurm_bench_wscale_%j.out
#SBATCH --error=slurm_bench_wscale_%j.err
#SBATCH --time=0:35:00
...
conda run --no-capture-output -p /gpfs/scrubbed/jackkohm/conda-envs/Astro python -u bench_walker_scaling.py
