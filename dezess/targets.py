...
ALL_TARGETS = {
    ...
    "isotropic_60": lambda: isotropic_gaussian(60),
    "correlated_10": lambda: correlated_gaussian(10),
    "correlated_30": lambda: correlated_gaussian(30),
    "correlated_60": lambda: correlated_gaussian(60),
    "student_t_10": lambda: student_t(10),
    "mixture_5": lambda: gaussian_mixture(5),
    "mixture_10": lambda: gaussian_mixture(10),
    "funnel_10": lambda: neals_funnel(10),
    "funnel_30": lambda: neals_funnel(30),
    "rosenbrock_4": lambda: rosenbrock(4),
    "rosenbrock_8": lambda: rosenbrock(8),
    "ill_conditioned_10": lambda: ill_conditioned_gaussian(10),
    "ill_conditioned_30": lambda: ill_conditioned_gaussian(30),
    "ill_conditioned_60": lambda: ill_conditioned_gaussian(60, condition=1e4),
