#!/bin/bash
#SBATCH --job-name=bench_arviz
#SBATCH --output=slurm_bench_arviz_%j.out
#SBATCH --error=slurm_bench_arviz_%j.err
#SBATCH --time=0:20:00
...
conda run --no-capture-output -p /gpfs/scrubbed/jackkohm/conda-envs/Astro python -u bench_slice_vs_mh_arviz.py
