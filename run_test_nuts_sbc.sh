#!/bin/bash
#SBATCH --job-name=test_nuts_sbc
#SBATCH --output=slurm_test_nuts_sbc_%j.out
#SBATCH --error=slurm_test_nuts_sbc_%j.err
#SBATCH --time=0:20:00
...
conda run --no-capture-output -p /gpfs/scrubbed/jackkohm/conda-envs/Astro python -u dezess/tests/test_nuts_sbc.py
